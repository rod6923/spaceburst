...
<button class="back-button" onclick="goBack()">
  ...
  <div class="container">
    <div class="form-box">
      ...
      <form id="register-form" class="active" method="post">
        <h2>Cadastre-se e começe sua aventura</h2>
        <input name="username" type="text" placeholder="Nome" required>
        <input name="email" type="email" placeholder="E-mail" required>
        <input name="senha" type="password" placeholder="Senha" required>
        <div class="form-toggle">
            <button onclick="trocar()" id="login-toggle2">Já possuo conta</button>
...
// Função para redirecionar o usuário para a página inicial
function trocar() {
window.location.href = "login.php"; // Substitua "index.html" pelo nome do arquivo da sua página inicial
}
...
<script>
        ...
        function toggleForm(formId) {
            document.querySelectorAll('.form-container form').forEach(form => form.classList.remove('active'));
        ...
        // Verifica se a mensagem de sucesso foi passada pelo PHP
